...
export const translations = {
  ...
  "kana": {
    ...
    "subpage3": {
      ...
      "sokuonDetail": "Sokuon (促音) adalah っ kecil (atau ッ dalam katakana) yang menghasilkan bunyi \"konsonan berganda\". っ dikira sebagai 1 mora penuh walaupun tidak berbunyi. Ia hanya menambah hentian singkat sebelum konsonan berikutnya.",
      "yoonTitle": "Yōon (ゃ, ゅ, ょ)",
      "yoonDesc": "Yōon (拗音) adalah gabungan bunyi apabila ゃ, ゅ, atau ょ kecil mengikuti kana baris い (き, し, ち, に, ひ, み, り, ぎ, じ, び, ぴ) untuk membentuk satu bunyi baharu. Kana biasa + ゃ/ゅ/ょ kecil bergabung menjadi satu bunyi dan tidak boleh menyebutnya secara berasingan."
    }
  },
  "kanjiRules": {
