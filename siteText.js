...
export const translations = {
  en: {
    ...
    introduction: {
      ...
      pitchAccentDesc: "The same word can have different meanings depending on which syllable has the high pitch. Differs between Tokyo, Kansai, and other dialects. It is best to learn this early. Unlearning wrong pronunciation habits later is much harder than building good ones from the start.",
  ...
  my: {
    ...
    introduction: {
      ...
      moraTitle: "Mora: Masa Jepun",
      moraIntro: "Bahasa Jepun tidak dikira dalam suku kata. Ia dikira dalam morae (拍 / ha-ku). Setiap mora adalah satu bukti santai yang sama rata. Seluruh irama bahasa dibina dengan memberikan setiap mora tempoh pendek yang sama.",
      moraIntro2: "Mendapat kiraan mora yang betul, dan memberikan setiap bukti panjang yang sama, adalah apa yang memisahkan pembelajaran semulajadi daripada pembelajaran yang hanya difahami dengan usaha.",
      ...
      moraNekoSakura: "ねこ (ne-ko) = 2 morae, さくら (sa-ku-ra) = 3 morae",
      moraN: "ん = 1 mora",
      moraNasal: "Bunyi nasal di hujung (cth, にほん = ni-ho-n = 3 morae)",
      // Sound rules
      ...
      pitchAccentDesc: "Perkataan yang sama boleh mempunyai makna yang berbeza bergantung pada suku kata mana yang mempunyai pitch tinggi. Berbeza antara Tokyo, Kansai, dan dialek lain. Sebaiknya pelajari ini dari awal. Menyingkirkantabiat pengeluaran yang salah kemudian akan lebih susah daripada membina yang baik dari awal.",
      pitchChopsticks: "chopsticks",
      pitchBridge: "bridge",
      // Tip
